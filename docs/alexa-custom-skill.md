...
- If you want account linking, add it to the Custom Skill with the OAuth server under [`oauth-server/`](../oauth-server/README.md).
...
- Import the latest interaction model from [`examples/alexa_interaction_model.json`](../examples/alexa_interaction_model.json) and rebuild it after gateway updates.
